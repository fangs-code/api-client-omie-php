...
class ClienteEntityOmieModel
{
     ...
     */
    protected ?string $valorLimiteCredito = null;
     ...
     * @return string|null
     */
    public function getValorLimiteCredito(): ?string
    {
        return $this->valorLimiteCredito;
    }

    /**
     * @param string|null $valorLimiteCredito
     *
     * @return ClienteEntityOmieModel
     */
    public function setValorLimiteCredito(?string $valorLimiteCredito): ClienteEntityOmieModel
    {
